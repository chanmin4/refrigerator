...
def run_detection():
    ...
    # 웹캠 초기화
    cap = cv2.VideoCapture(0)  # 대부분의 경우 기본 웹캠은 인덱스 0을 사용합니다.
    if not cap.isOpened():
    ...
    PATH_TO_CKPT = './realsense/saved_model_food101.pb'  # .pb 파일 경로
    PATH_TO_LABELS = './realsense/mscoco_label_map_food101.pbtxt'  # 레이블 맵 경로
    ...
    NUM_CLASSES = 101  # 클래스 수를 90에서 101로 변경
